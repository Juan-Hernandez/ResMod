...
@everywhere include("momentsimulator!.jl")
@everywhere include("solvereservesmodel!.jl")
# 1. Define parameters
...
# 1.1.4 Four parameter vector [beta, par1, par2, wealthmean]
...
pmap( momentsimulator!, repeated(basecompuparams,itermax), 
	[ baseeconparams=EconParams(
		# Consumer
		parvec[1]*(1+growth)^(1-ggamma),			# bbeta::Float64
