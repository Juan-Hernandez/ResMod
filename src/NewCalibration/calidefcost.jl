...
calsequence=SobolSeq(2, [0.01, 0.1], [0.09, 0.9])
...
pmap( momentsimulator!, Iterators.repeated(basecompuparams,itermax), 
	[ baseeconparams=EconParams(
		...
		2*parvec[1]-parvec[2],					# defcost1::Float64
		(parvec[2]-parvec[1])/pivot,				# defcost2::Float64
		0.125,	 									# reentry::Float64
		# Sudden Stop Probability
		20.0, 										# panicfrequency::Float64 -- One every 16 quarters
		6   										# panicduration::Float64 -- 8 quarters
		)
