module calibrateSA
	...
	calibration=optimize(momentsgap3, [log(0.97/0.02), log(0.0875/0.8625), log(0.32/0.18)], SimulatedAnnealing(), OptimizationOptions(show_trace=true) )
	...
	println(" \n Star parameters:")
	showcompact([bbetastar, defcon1star, df2ratiostar])
