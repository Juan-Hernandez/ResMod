...
ClusterManagers.addprocs_sge(35,queue="all.q",qsub_env="LD_LIBRARY_PATH")
...
pivot=0.892 	# Pivot point for default cost # Point--ergodic prob: 0.867--0.020,  0.892--0.044, 0.918--0.078
