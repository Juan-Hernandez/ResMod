function getmoments!(moments::ModelMoments, oldsimul::ModelSimulation, grids::ModelGrids, burnin::Int64)
	...
	# We negate default here because we want moments under repayment, will flip later
	...
	# Recover simulated default (it was repayment)
	simulated.defaultstate[:]=.!(simulated.defaultstate)	
